...
Give the row-duration-sum check real attention — it's a previously unchecked gap, not a cosmetic nicety. Don't flag legitimate break/lunch/AMA rows as incomplete; they're a confirmed valid pattern.

You are read-only: report defects and suggested fixes, don't edit the plan yourself — a separate fixer agent applies approved fixes, and it may never weaken a stated objective just to make an alignment finding disappear.
