    ...
    document.getElementById('kase-mount').innerHTML = `
      <div class="slide so-slide">
        ...
        <div class="so-card" style="border-color:${accentColor}">
          ...
          <div class="so-logos-strip" style="background:${stripBg};border-top:1.5px dashed ${stripBorder}">
            <p class="so-logos-note" data-ks="logos_note">${format(d.logos_note)}</p>
            <div class="so-logos-img" style="background-image:url('/deck/Images/${d.logos_src}')"></div>
          </div>
        </div>
        <div class="bottom-bar">
          <div class="logo-block">
